(async () => {
    ...
    document.getElementById('sort-by-username').addEventListener('click', () => {
    ...
    // сортировка по емейл
    document.getElementById('sort-by-email').addEventListener('click', () => {
    ...
    document.getElementById('sort-by-website').addEventListener('click', () => {
